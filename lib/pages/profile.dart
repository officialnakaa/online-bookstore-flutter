...
// Create a class for the profile header (picture + full name)
// Mirrors the role "Categories" plays in books.dart
...
// Create a class for the list of user details.
// This is now StatefulWidget instead of StatelessWidget, because Email,
// Phone Number, and Password can change while the page is open — a
// StatelessWidget has no memory of its own, so editing wouldn't stick.
...
class _ProfileDetailsState extends State<ProfileDetails> {
  // These used to be local variables inside build(). Now they're state
  // fields, so updating them with setState() and rebuilding actually
  ...
  // Reused for both Email and Phone Number — a single text field
  ...
  // Password gets its own dialog: two obscured fields plus inline
  // validation, instead of just editing the displayed "********".
  void _showChangePasswordDialog() {
    ...
    showDialog(
      context: context,
      builder: (context) {
        // StatefulBuilder gives this dialog its own tiny bit of state
        // (just for the error message) without needing to rebuild the
        // whole ProfileDetails list behind it.
...
// Create a reusable widget for a single detail row
// Mirrors the role "BookCard" plays in books.dart
